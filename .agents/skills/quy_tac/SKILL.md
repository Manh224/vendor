---
name: quy_tac
description: Bộ 6 nguyên tắc hành vi cho AI assistant khi làm việc với project. Bao gồm quy tắc về tư duy trước khi code, đơn giản hóa, thay đổi chính xác, thực thi có mục tiêu, giao tiếp đúng ngôn ngữ, và bảo toàn cấu trúc dự án.
---
